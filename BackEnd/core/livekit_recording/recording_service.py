...
class StreamingRecordingWithChunks:
    ...
    def _start_audio_clock_thread(self):
        ...
        def audio_clock_loop():
            ...
            # FINAL FLUSH: Write silence and wait for FFmpeg to catch up
...
class FixedGoogleMeetRecorder:
    ...
    def __init__(self):
        ...
        self.livekit_url = os.getenv("LIVEKIT_URL", "wss://imeetpro-7yq8bbet.livekit.cloud")
        self.livekit_wss_url = os.getenv("LIVEKIT_WSS_URL", "wss://imeetpro-7yq8bbet.livekit.cloud")
