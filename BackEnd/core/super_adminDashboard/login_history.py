...
urlpatterns = [
    path('api/admin/login-history/', Get_All_Login_History, name='get_all_login_history'),
    path('api/admin/active-sessions/', Get_Active_Sessions, name='get_active_sessions'),
    path('api/admin/login-stats/', Get_Login_Statistics, name='get_login_statistics'),
    path('api/admin/force-logout/<int:login_id>/', Force_Logout_Session, name='force_logout_session'),
    path('api/admin/force-logout-user/<int:user_id>/', Force_Logout_User_All_Sessions, name='force_logout_user'),
    path('api/admin/clear-login-history/', Clear_Login_History, name='clear_login_history'),
    path('api/user/login-history/<int:user_id>/', Get_User_Login_History, name='get_user_login_history'),
]