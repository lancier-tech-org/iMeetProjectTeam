...
urlpatterns = [
    ...
    path('api/plan/lists', List_All_Plans, name='List_All_Plans'),
    path('api/plan/list/<int:id>', Get_Plan, name='Get_Plan'),
    path('api/plan/update/<int:id>', Update_Plan, name='Update_Plan'),
    path('api/plan/remove/<int:id>', Delete_Plan, name='Delete_Plan'),
    path('api/plan/filter', Filter_Plans_By_Billing_Period, name='Filter_Plans_By_Billing_Period'),
]