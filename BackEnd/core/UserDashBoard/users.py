...
# ============================================================================
try:
    from core.super_adminDashboard.login_history import (
        record_login_history,
        record_logout,
        create_login_history_table,
    )
    LOGIN_HISTORY_ENABLED = True
    logging.info("✓ Login history module imported successfully")
except ImportError as e:
    logging.warning(f"⚠ Login history module not available: {e}")
