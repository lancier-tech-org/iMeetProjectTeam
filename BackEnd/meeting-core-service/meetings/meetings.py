...
from typing import Optional, Dict, List, Any
import pytz
from participants.participants import get_or_create_participant_for_occurrence, record_participant_leave
import urllib3
import random
import string
...
try:
    from clients.attendance_client import start_attendance_tracking, stop_attendance_tracking
    ATTENDANCE_ENABLED = True
    print("✅ Attendance client loaded successfully")
except ImportError as e:
    ATTENDANCE_ENABLED = False
    print(f"⚠️ Attendance client not available: {e}")
...
def Get_User_Schedule_Meetings(request):
    ...
    try:
        ...
        from utils.recurring_calculator import calculate_next_occurrence
...
def leave_livekit_meeting(request):
    ...
    try:
        ...
        try:
            from clients.attendance_client import stop_attendance_tracking
