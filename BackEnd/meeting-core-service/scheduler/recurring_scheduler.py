...
from utils.date_utils import get_current_ist_datetime, format_datetime_for_db
from utils.recurring_calculator import (
    calculate_next_occurrence, 
    get_todays_meetings, 
    is_recurrence_ended,
    should_send_reminder
)
from scheduler.email_scheduler import send_daily_meeting_reminders
...
def update_meeting_to_next_occurrence(meeting, next_occurrence):
    ...
    try:
        ...
        from utils.date_utils import parse_datetime_safely
...
def send_meeting_reminder_email(meeting, reminder_minutes):
    ...
    try:
        from scheduler.email_scheduler import send_meeting_reminder
