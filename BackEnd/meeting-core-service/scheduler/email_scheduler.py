...
from utils.date_utils import get_current_ist_datetime, parse_datetime_safely
from utils.recurring_calculator import calculate_next_occurrence, should_send_reminder

def send_daily_meeting_reminders():
    """Send daily reminders for all applicable meetings"""
    try:
        from scheduler.recurring_scheduler import get_active_recurring_meetings, get_todays_scheduled_meetings
...
def send_daily_invitation_emails():
    ...
    try:
        from scheduler.recurring_scheduler import get_todays_scheduled_meetings
