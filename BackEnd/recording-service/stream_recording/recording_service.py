...
import math
from video_processing.recordings import collection
...
AWS_S3_BUCKET = os.getenv("AWS_S3_BUCKET", "imeetpro-225220763325")
...
class FixedGoogleMeetRecorder:
    ...
    def __init__(self):
        ...
        self.livekit_url = os.getenv("LIVEKIT_URL", "wss://192.168.48.201:8443")
        self.livekit_wss_url = os.getenv("LIVEKIT_WSS_URL", "wss://192.168.48.201:8443")
