...
# ============================================================================
try:
    from auth.face_model_shared import get_face_model, compare_embeddings
    FACE_RECOGNITION_ENABLED = True
    face_model = None
except ImportError as e:
    FACE_RECOGNITION_ENABLED = False
    face_model = None
    print(f"⚠️  Warning: Could not import face_model_shared: {e}")
