...
const { logoUrl } = useCompanyLogo();
  ...
  // ============================================================================
  // ✅ FIXED: Async logout that calls backend API to record logout history
  // ============================================================================
  const handleLogout = async () => {
    ...
    try {
      await logout(); // Wait for logout to complete (calls backend API)
      console.log('✅ [MainLayout] Logout successful');
    } catch (error) {
      console.error('⚠️ [MainLayout] Logout error:', error);
    } finally {
      navigate("/auth"); // Always navigate to auth page
    }
  };
