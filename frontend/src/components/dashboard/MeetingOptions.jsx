...
const MeetingOptions = ({ isDarkMode = false }) => {
  ...
  const colors = {
    ...
    cardBorder: isDarkMode ? 'rgba(255,255,255,0.1)' : '#E5E7EB',
    textPrimary: isDarkMode ? '#ffffff' : '#1F2937',
    textSecondary: isDarkMode ? 'rgba(255,255,255,0.6)' : '#6B7280',
    inputBg: isDarkMode ? 'rgba(255,255,255,0.05)' : 'white',
  };

  // Meeting types with teal-blue color scheme
  const meetingTypes = [
    {
      id: 'instant',
      ...
      color: '#1A8A8A',
      bgColor: isDarkMode ? 'rgba(26, 138, 138, 0.2)' : 'rgba(26, 138, 138, 0.1)',
      borderColor: isDarkMode ? 'rgba(26, 138, 138, 0.3)' : 'rgba(26, 138, 138, 0.2)',
    ...
    },
    {
      ...
      color: '#2D7DD2',
      bgColor: isDarkMode ? 'rgba(45, 125, 210, 0.2)' : 'rgba(45, 125, 210, 0.1)',
      borderColor: isDarkMode ? 'rgba(45, 125, 210, 0.3)' : 'rgba(45, 125, 210, 0.2)',
              ...
              >
                <CardContent sx={{ p: 2.5 }}>
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <ArrowForward sx={{ color: isDarkMode ? 'rgba(255,255,255,0.3)' : '#9CA3AF', fontSize: 20 }} />
                  </Stack>
                </CardContent>
              </Paper>
            </Grid>
      ...
      <Paper
        ...
        sx={{
          ...
          background: isDarkMode 
            ? 'linear-gradient(135deg, rgba(26, 138, 138, 0.1) 0%, rgba(45, 125, 210, 0.1) 100%)'
            : 'linear-gradient(135deg, rgba(26, 138, 138, 0.05) 0%, rgba(45, 125, 210, 0.05) 100%)',
          border: '1px solid',
          borderColor: isDarkMode ? 'rgba(45, 125, 210, 0.2)' : 'rgba(45, 125, 210, 0.15)',
          borderRadius: 3,
        }}
      >
      ...
      >
        <DialogTitle sx={{ 
          ...
          <IconButton 
            ...
            sx={{ 
              color: colors.textSecondary,
              '&:hover': { backgroundColor: isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(107, 114, 128, 0.1)' }
            }}
          >
            <Close />
          </IconButton>
        ...
        <DialogActions sx={{ 
          ...
          <Button 
            ...
            sx={{ 
              ...
              color: colors.textSecondary,
              '&:hover': {
                backgroundColor: isDarkMode ? 'rgba(255,255,255,0.05)' : 'rgba(107, 114, 128, 0.08)',
                borderColor: isDarkMode ? 'rgba(255,255,255,0.3)' : '#D1D5DB',
              }
            }}
          >
            Cancel
