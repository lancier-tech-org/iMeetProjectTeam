...
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://192.168.48.201';
export const WEBSOCKET_URL = import.meta.env.VITE_WEBSOCKET_URL || 'wss://192.168.48.201/wss';

// NEW: LiveKit Configuration
export const LIVEKIT_CONFIG = {
  url: import.meta.env.VITE_LIVEKIT_URL || 'wss://imeetpro-f10rvyi1.livekit.cloud',
  apiKey: import.meta.env.VITE_LIVEKIT_API_KEY || 'APIKZYhfbgZN9QT',
  apiSecret: import.meta.env.VITE_LIVEKIT_API_SECRET || 'bKv5vpOCJWb3jhDFibTthH8iuk575om9hFNaDafVVTf',
